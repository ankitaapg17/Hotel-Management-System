...
class Roombooking:
    def __init__(self, root):
     ...
     #title
        ...
        lbl_title=Label(self.root,text="ROOM BOOKING DETAILS",font=("timesnewroman",18,"bold"),bg="black",fg="gold")
        lbl_title.place(x=0,y=0,width=1295,height=50)

     #logo

        img2=Image.open(r"photo2.jpg")
     ...
     #labelframe
        ...
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Room booking Details",font=("timesnewroman",12,"bold"),padx = 2)
     ...
     #checkindate
        ...
        check_in_date.grid(row=0,column=0,sticky=W)
     ...
     #checkoutdate
        ...
        lbl_Check_out.grid(row=0,column=0,sticky=W)
     ...
     #availableroom
       ...
       #txtRoomAvailable=ttk.Entry(labelframeleft,textvariable=self.var_roomavailable,font=("arial",13,"bold"),width = 29)t
      ...
      #buttons
        ...
        btnReset.grid(row = 0, column = 0, padx = 1)
        ...
        #tableframesearchsystem

        Table_Frame=LabelFrame(self.root,bd=2,relief=RIDGE,text="View details and Search System",font=("timesnewroman",12,"bold"),padx = 2)
        Table_Frame.place(x=435,y=280,width = 860, height = 260)

        lblSearchBy= Label(labelframeleft,font =("arial",12,"bold"),text = "Search By: ",bg = "red" ,fg ="white")
        lblSearchBy.grid(row= 0,column=0,sticky= W)

        combo_Search = ttk.Combobox(Table_Frame,font=("arial",13,"bold"),width = 27,state="readonly")
        ...
        btnSearch = Button(btn_frame, text = "Search",command=self.search,font = (" arial", 11, "bold"), bg = "black", fg = "gold", width= 10)
        btnSearch.grid(row = 0, column = 3, padx = 1)

        btnShowAll = Button(btn_frame, text = "Show All",command=self.fetch_data,font = (" arial", 11, "bold"), bg = "black", fg = "gold", width= 10)
        ...
        self.room_table.heading("contact",width=100)
        self.room_table.heading("checkin",width=100 )
        self.room_table.heading("checkout",width=100)
        self.room_table.heading("roomtype",width=100)
        self.room_table.heading("roomavailable",width=100)
        self.room_table.heading("meal",width=100)
        self.room_table.heading("noOfdays",width=100)
        self.room_table.pack(fill=BOTH,expand=1)

        self.room_table.bind("<ButtonRelease-1>",self.get_cursor())
        self.fetch_data()

    def add_data(self): #database connectivity
    ...
    def total(self):
        ...
        #if (self.var_meal.get()=="BreakFast" and self.var_roomtype=="luxury"):
